...
class MetaGameStateMapper extends SubClassMapperBase<MetaGameState> {
  ...
  static GamePlayerId _$nextPlayer(MetaGameState v) => v.nextPlayer;
  static const Field<MetaGameState, GamePlayerId> _f$nextPlayer = Field(
    'nextPlayer',
    _$nextPlayer,
  );
  ...
  @override
  final dynamic discriminatorValue = 'MetaGameState';
  @override
...
class MetaMoveMapper extends ClassMapperBase<MetaMove> {
  ...
  static GamePlayerId _$player(MetaMove v) => v.player;
  static const Field<MetaMove, GamePlayerId> _f$player = Field(
    'player',
    _$player,
  );
...
abstract class MetaMoveCopyWith<$R, $In extends MetaMove, $Out>
  ...
  $R call({int? turn, GamePlayerId? player, MetaPosition? pos});
...
class _MetaMoveCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({int? turn, GamePlayerId? player, MetaPosition? pos}) => $apply(
    FieldCopyWithData({
